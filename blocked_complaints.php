...
//query to retricve data from complaint db
    ...
    <section class="complaint-body">
        <div class="card">
            <div class="card-header">
                <h1 style="text-align:center;font-weight:bold;">Blocked Complaints</h1>
            </div>
            <div class="card-body">
                <blockquote class="blockquote mb-0">
                    <div style="overflow-x:auto;">
                        <table>
                            <!-- table for blocked complaints -->
                            <thead>
                                <tr>
                                    <!-- table head for bolcked complaints table -->
                                    <th>Sr</th>
                                    <th>Image</th>
                                    <th>Complaint</th>
                                    <th>Area</th>
                            ...
                            <tbody>
                                <?php
                                if ($num > 0) {
                                    //checks the feedback status is blocked. if it is blocked then display
